...
- [X] T019 Rodar a validação completa de [quickstart.md](./quickstart.md) nos dois aparelhos-alvo (Redmi Note 12/Android e iPhone 16 Plus/iOS), conforme Constituição Princípio III, cobrindo todos os 6 cenários de ponta a ponta antes de considerar o RF08 concluído. **Android: ✅ concluído** — usuário confirmou os cenários 1, 2, 3, 4 e 5 (perfil novo sem histórico, exercícios novos sem histórico, troca de perfis sem misturar treinos importados para o teste) em dispositivo real, coerente com o esperado. **iOS: ✅ concluído** — usuário confirmou os mesmos cenários no iPhone 16 Plus, histórico OK. RF08 validado de ponta a ponta nos dois aparelhos-alvo, Princípio III satisfeito.
...
- [X] T022 Validar manualmente, no Redmi Note 12 (e depois no iPhone 16 Plus, quando o build iOS existir), que a barra de abas agora exibe "Treinos" e "Histórico" corretamente, em ambos os temas claro/escuro. **Confirmado pelo usuário** — testes de histórico realizados em ambos os aparelhos implicam navegação pela aba "Histórico" já renomeada; nenhum problema relatado. Verificação explícita de tema claro/escuro não mencionada separadamente pelo usuário.
