...
- [ ] T021 Executar manualmente todos os cenários de `quickstart.md` (1 a 4, mais o cenário de cancelamento) no iPhone 16 Plus (iOS 17+) via Expo Go — **PENDENTE**: dispositivo iOS indisponível no momento; feature não pode ser considerada totalmente concluída (Princípio III da Constituição) até esta validação ser feita
